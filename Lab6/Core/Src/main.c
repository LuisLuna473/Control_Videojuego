...
/* USER CODE BEGIN PV */
uint8_t buffer[10]; //Buffer que recive comandos
...
// Banderas para los caracteres 'a', 'b', 'c', 'd', 'e', 'f'
uint8_t flags[6] = {0};  // 0 para no enviado, 1 para enviado
/* USER CODE END PV */
